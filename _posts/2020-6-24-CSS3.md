...
实线：`background-size: 100px auto` `linear-gradient(90deg, #000,#000)`

长划线：`background-size: 12px auto` `linear-gradient(90deg, #000 70%, transparent 70%)`

短划线：`background-size: 7px auto` `linear-gradient(90deg, #000 60%, transparent 60%)`

圆点：`background-size: 4px auto` `linear-gradient(90deg, #000 70%, transparent 70%)`

方点：`background-size: 2px auto` `linear-gradient(90deg, #000 50%,transparent 50%)`

划线-点：`background-size: 2px auto` `linear-gradient(90deg, #000 40%, transparent 40%,  transparent 65%,  #000 65%, #000 75%, transparent 75%)`

长划线-点-点：`background-size: 2px auto` `linear-gradient(90deg, #000 45%, transparent 45%, transparent 60%, #000 60%,  #000 65%, transparent 65%, transparent 80%, #000 80%, #000 85%, transparent 85%)`
...
css过渡，即稳定状态下数值改变；要求起始状态存在初始数值，`display` 这种非数值改变无法过渡；
